...
<head>
    ...
    <title>MenstrualTracker API Documentation</title>
...
<p>This API is not authenticated.</p>
        ...
        <h1 id="authentication">Authentication</h1>
                                ...
                                <h2 id="authentication-POSTapi-register">Регистрация нового пользователя</h2>
...
<div class="bash-example">
    ...
    --get "http://localhost:8000/api/email/verify/consequatur/consequatur?expires=consequatur&amp;signature=consequatur" \
    --header "Content-Type: application/json" \
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="expires"                data-endpoint="GETapi-email-verify--id---hash-"
               value="consequatur"
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="signature"                data-endpoint="GETapi-email-verify--id---hash-"
               value="consequatur"
               data-component="query">
    <br>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="authentication-POSTapi-logout">Выход из системы</h2>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be a valid date. Must be a date after or equal to <code>start_date</code>. Example: <code>2106-12-09</code></p>
        </div>
        </form>
...
<span id="example-requests-POSTapi-calendar">
<blockquote>Example request:</blockquote>
...
<span id="execution-results-POSTapi-calendar" hidden>
    ...
    <pre class="json"><code id="execution-response-content-POSTapi-calendar"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-calendar" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-calendar">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-calendar" data-method="POST"
      data-path="api/calendar"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-calendar', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-calendar"
                    onclick="tryItOut('POSTapi-calendar');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-calendar"
                    onclick="cancelTryOut('POSTapi-calendar');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-calendar"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-calendar"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-calendar"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <label data-endpoint="POSTapi-calendar" style="display: none">
            <input type="radio" name="is_period"
                   value="true"
                   data-endpoint="POSTapi-calendar"
                   data-component="body"             >
            <code>true</code>
        </label>
        <label data-endpoint="POSTapi-calendar" style="display: none">
